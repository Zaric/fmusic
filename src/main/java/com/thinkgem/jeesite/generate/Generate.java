...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		String classPath = new DefaultResourceLoader().getResource("")
				.getFile().getPath();
		String templatePath = classPath.replace(separator + "webapp"
				+ separator + "WEB-INF" + separator + "classes", separator
				+ "java" + separator + "com" + separator + "thinkgem"
				+ separator + "jeesite" + separator + "modules");
		String javaPath = classPath.replace(
				separator + "webapp" + separator + "WEB-INF" + separator
						+ "classes",
				separator
						+ "java"
						+ separator
