...
public class Category extends BaseEntity {
	...
	// "seq_cms_category")
	// @SequenceGenerator(name = "seq_cms_category", sequenceName =
	// "seq_cms_category")
	public Long getId() {
		return id;
	}
	...
	@JoinTable(name = "sys_role_category", joinColumns = { @JoinColumn(name = "category_id") }, inverseJoinColumns = { @JoinColumn(name = "role_id") })
	@Where(clause = "del_flag='" + DEL_FLAG_NORMAL + "'")
	@OrderBy("id")
